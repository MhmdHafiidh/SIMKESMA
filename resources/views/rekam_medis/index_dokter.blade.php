        ...
        <div class="card-body" style="background-color: #eef2f7;">
            <div class="table-responsive">
                <table class="table" id="dataTable"
                    style="width: 90%; margin: auto; background-color: white; border-collapse: collapse; border-radius: 12px; overflow: hidden; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.1);">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($rekamMedis as $rekam)
                            <tr style="transition: all 0.2s ease;">
                                <td style="padding: 1.2rem;">{{ $rekam->id }}</td>
                                <td style="padding: 1.2rem;">{{ $rekam->mahasiswa->name }}</td>
                                <td style="padding: 1.2rem;">{{ $rekam->keluhan }}</td>
                                ...
                                <td style="padding: 1.2rem;">
                                    <a href="{{ route('rekam_medis.show', $rekam->id) }}"
                                        style="color: #0056b3; text-decoration: none; font-weight: bold; padding: 0.5rem 1rem; border: 1px solid #0056b3; border-radius: 8px; transition: all 0.3s ease;">
